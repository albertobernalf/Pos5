...
class Cirugias(models.Model):
    ...
    #estadoCirugia = models.ForeignKey('cirugia.EstadosCirugia', blank=True, null=True, editable=True,   on_delete=models.PROTECT)
...
class ProgramacionCirugias(models.Model):
    ...
    estadoProgramacion = models.ForeignKey('cirugia.EstadosProgramacion', blank=True, null=True, editable=True,   on_delete=models.PROTECT) 
    fechaProgramacionInicia = models.DateTimeField(default=date.today, blank=True, null=True, editable=True)
    horaProgramacionInicia = models.CharField(max_length=5, blank=True, null=True, editable=True)
    fechaProgramacionFin = models.DateTimeField(default=date.today, blank=True, null=True, editable=True)
