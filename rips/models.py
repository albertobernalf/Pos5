...
class RipsConsultas (models.Model):
    ...
    numDocumentoIdentificacion = models.CharField(max_length=20, blank=True,null= True, editable=True)
    vrServicio = models.DecimalField(max_digits=10, decimal_places=2, default=0)
...
class RipsMedicamentos(models.Model):
   ...
   cantidadMedicamento = models.DecimalField(max_digits=10, decimal_places=0,  blank=True, null=True ,default=0)
   diasTratamiento = models.DecimalField(max_digits=3, decimal_places=0,   blank=True, null=True, default=0)
