...
{"ResultState":true,"ProcesoId":25785,"NumFactura":"CME443346","CodigoUnicoValidacion":"7a4cf97c395e46032be834df7db8b2c644db744649229a900c0690691ee4a8f9daafecfccadc11e650e99439b9e2b5b8","FechaRadicacion":"2025-02-16T07:38:58.9031792-05:00","RutaArchivos":null,"ResultadosValidacion":[{"Clase":"NOTIFICACION","Codigo":"FED129","Descripcion":"[Interoperabilidad.Group.Collection.AdditionalInformation.NUMERO_CONTRATO.Value] El apartado no existe o no tiene valor en el XML del documento electrónico. Por favor verifique que la etiqueta Xml use mayúsculas y minúsculas según resolución","Observaciones":"","PathFuente":"","Fuente":"FacturaElectronica"},{"Clase":"NOTIFICACION","Codigo":"FED131","Descripcion":"[Interoperabilidad.Group.Collection.AdditionalInformation.NUMERO_POLIZA.Value] El apartado no existe o no tiene valor en el XML del documento electrónico. Por favor verifique que la etiqueta Xml use mayúsculas y minúsculas según resolución","Observaciones":"","PathFuente":"","Fuente":"FacturaElectronica"},{"Clase":"NOTIFICACION","Codigo":"RVC017","Descripcion":"El código de CUPS puede ser validado que corresponda a la cobertura o plan de beneficios informada en la factura electrónica de venta.","Observaciones":"Verificar tabla de referencia Dato (890701)","PathFuente":"usuarios[0].servicios.consultas[0].codConsulta","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC019","Descripcion":"El código de CUPS se puede validar con el diagnóstico principal.","Observaciones":"Verificar tabla de referencia Dato (890701)","PathFuente":"usuarios[0].servicios.consultas[0].codConsulta","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC059","Descripcion":"El código de CUPS puede ser validado con el grupo de servicio, servicio, finalidad o causa.","Observaciones":"Verificar tabla de referencia CodConsulta (890701) - Finalidad (15)","PathFuente":"usuarios[0].servicios.consultas[0].codConsulta","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC086","Descripcion":"Se puede validar que el código de diagnóstico relacionado no sea igual al código de diagnóstico principal.","Observaciones":"Codigo de diagnóstico repetido","PathFuente":"usuarios[0].servicios.medicamentos[0].codDiagnosticoRelacionado","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC063","Descripcion":"Se podrá validar la existencia del IUM o del CUM en el catálogo respectivo de SISPRO.","Observaciones":"El código de la tecnología  [19992190-03] no es válido, por favor verificar tabla de referencia.","PathFuente":"usuarios[0].servicios.medicamentos[0].codTecnologiaSalud","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC065","Descripcion":"Para 01: Medicamento con uso según registro sanitario, 02: Medicamento con uso como vital no disponible definido por INVIMA o 04: Medicamento con uso no incluido en el registro sanitario(Listado UNIRS) puede informar null.","Observaciones":"Tenga en cuenta que no es necesario que informe dato para el tipo de medicamento informado ya que el Ministerio de Salud y Protección Social obtiene los datos del medicamento informado a partir del código informado.","PathFuente":"usuarios[0].servicios.medicamentos[0].nomTecnologiaSalud","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC065","Descripcion":"Para 01: Medicamento con uso según registro sanitario, 02: Medicamento con uso como vital no disponible definido por INVIMA o 04: Medicamento con uso no incluido en el registro sanitario(Listado UNIRS) puede informar null.","Observaciones":"Tenga en cuenta que no es necesario que informe dato para el tipo de medicamento informado ya que el Ministerio de Salud y Protección Social obtiene los datos del medicamento informado a partir del código informado.","PathFuente":"usuarios[0].servicios.medicamentos[0].concentracionMedicamento","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"RVC065","Descripcion":"Para 01: Medicamento con uso según registro sanitario, 02: Medicamento con uso como vital no disponible definido por INVIMA o 04: Medicamento con uso no incluido en el registro sanitario(Listado UNIRS) puede informar null.","Observaciones":"Tenga en cuenta que no es necesario que informe dato para el tipo de medicamento informado ya que el Ministerio de Salud y Protección Social obtiene los datos del medicamento informado a partir del código informado.","PathFuente":"usuarios[0].servicios.medicamentos[0].unidadMedida","Fuente":"Rips"},{"Clase":"NOTIFICACION","Codigo":"FED129","Descripcion":"[Interoperabilidad.Group.Collection.AdditionalInformation.NUMERO_CONTRATO.Value] El apartado no existe o no tiene valor en el XML del documento electrónico. Por favor verifique que la etiqueta Xml use mayúsculas y minúsculas según resolución","Observaciones":"","PathFuente":"","Fuente":"FacturaElectronica"},{"Clase":"NOTIFICACION","Codigo":"FED131","Descripcion":"[Interoperabilidad.Group.Collection.AdditionalInformation.NUMERO_POLIZA.Value] El apartado no existe o no tiene valor en el XML del documento electrónico. Por favor verifique que la etiqueta Xml use mayúsculas y minúsculas según resolución","Observaciones":"","PathFuente":"","Fuente":"FacturaElectronica"}]}
